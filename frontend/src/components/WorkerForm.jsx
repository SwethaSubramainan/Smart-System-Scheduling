...
const WorkerForm = ({ onSubmit }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        onSubmit(formData);
        setFormData({ name: '', skill: '', status: 'Available' });
    };
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 mb-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-end">
                ...
                <div className="flex-1 w-full">
                    ...
                    <select name="skill" value={formData.skill} onChange={handleChange} required className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all bg-white">
